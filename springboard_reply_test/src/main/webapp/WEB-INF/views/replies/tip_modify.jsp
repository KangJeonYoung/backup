	...
	<div class="col-lg-12">
		<div class ="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" action="/replies/tip_modify" method="post">
					<div class="row">
...
<%-- 					<div class="col-md-6 pr-1">					
					...
					<button type="button" date-oper='list' onclick="location.href='/board/questions_list'" class ="btn btn-default">리스트</button>					
				</form>					
